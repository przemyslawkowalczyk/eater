...
export class App extends React.Component<App.Props> {
  ...
  private static async getData() {
    const [ dish, menu, restaurants ] = await Promise.all([
      axios.get('http://localhost:3000/dish/all'),
      axios.get('http://localhost:3000/menu/all'),
      axios.get('http://localhost:3000/restaurant/all'),
    ]);

    console.log('dishes', dish, dish.data);
    console.log('menus', menu, menu.data);
    console.log('restaurants', restaurants, restaurants.data);
  }
